...
public class NetherAlloySmeltingCategory extends AbstractRecipeCategory<INetherAlloyRecipe> {

    public static final RecipeType<INetherAlloyRecipe> RECIPE_TYPE =
            RecipeType.create("overgeared_jei_compat", "nether_alloy_smelting", INetherAlloyRecipe.class);
    ...
    public NetherAlloySmeltingCategory(IGuiHelper helper) {
        super(RECIPE_TYPE,
                Component.translatable("jei.overgeared_jei_compat.nether_alloy_smelting"),
                helper.createDrawableItemLike(ModBlocks.NETHER_ALLOY_FURNACE.get()),
                WIDTH, HEIGHT);
    ...
    @Override
    public void draw(INetherAlloyRecipe recipe, IRecipeSlotsView slotsView, GuiGraphics graphics, double mouseX, double mouseY) {
